 ...
 */
public class UsrInfListComposite extends Composite implements CallbackIF{

	protected static Log log = LogFactory.getLog(UsrInfListComposite.class);
	...
	private String[] colName = { "", "", "No", "ID", "사용자명", "연락처", "등급", "비고"};
	...
	private ArrayList<CmUsrInfDTO> listData;
	...
	public static void showGUI() {
		...
		UsrInfListComposite inst = new UsrInfListComposite(shell, SWT.NULL);
	...
	public UsrInfListComposite(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
...
//				gridViewer.getGrid().setRowHeaderVisible(true);
	...
	public class ListGridLabelProvider extends LabelProvider implements ITableLabelProvider, ITableFontProvider,
		...
		public String getColumnText(Object element, int columnIndex) {
			CmUsrInfDTO data = (CmUsrInfDTO) element;
	...
	private void selectData(){
		try{
			CmUsrInfDTO dto = new CmUsrInfDTO();
			dto.setDel_yn(DTSConstants.FLAG_N);
			dto.setAth_grd(usr.getAth_grd());
			if(!"".equals(txtSearch.getText().trim()))
				dto.setSearch(txtSearch.getText().trim());
			listData = mgr.selectUsrInf(dto);
