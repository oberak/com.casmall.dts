...
/**
 * HomeView 당일 계량 자료 표시
 * 
 * @author OBERAK
 */
public class WeighScndInftComposite extends org.eclipse.swt.widgets.Composite {
	...
	private String[] colName = { "No", "차량번호", "일자", "시간", "중량   ","시간", "중량   ","감량","실중량 " };
	/** 컬럼 너비 : 퍼센트 */
	...
	public static void showGUI() {
		...
		WeighScndInftComposite inst = new WeighScndInftComposite(shell, SWT.NONE);
	...
	public WeighScndInftComposite(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		setBackground(SWTResourceManager.getColor(SWT.COLOR_WHITE));
		initGUI();
	}// WeighSendInftComposite
	...
	private void initGird() {
		...
		gridViewer.getGrid().setItemHeight(32);
