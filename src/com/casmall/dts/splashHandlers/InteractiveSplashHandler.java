...
package com.casmall.dts.splashHandlers;
...
import com.casmall.dts.ui.common.AuthDialog;
...
public class InteractiveSplashHandler extends AbstractSplashHandler {
	...
	private void handleButtonOKWidgetSelected() {
		...
		try{
			...
			if(!mgr.checkLogin(username.trim(), password.trim())){
				...
				fTextPassword.setBackgroundImage(ImageRepository.getImage(ImageRepository.BG_LOGIN_PW));
				fTextUsername.setFocus();
				return;
			}
			try {
	...
	private void createUIButtonCancel() {
		...
		fButtonCancel.setBackgroundImage(ImageRepository.getImage(ImageRepository.BTN_LOGIN_CANCEL));
	...
	private void createUIButtonOK() {
		...
		fButtonOK.setBackgroundImage(ImageRepository.getImage(ImageRepository.BTN_LOGIN));
		Cursor cursor = new Cursor(Display.getDefault(), SWT.CURSOR_HAND);  
